<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"E:\phpstudy_pro\WWW\www.zhuxuezhi.com\public/../application/admin\view\login\login.html";i:1563975423;}*/ ?>
<!doctype html>
    ...
    <div class="login layui-anim layui-anim-up">
        ...
        <form method="post" class="layui-form" >
            ...
            <div class="layui-row">
              ...
              <img src="<?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random()" style="float: right;width: 50%;">
